...
class NOAAConfig:
    ...
    OLR_URL: str = "https://www.cpc.ncep.noaa.gov/data/indices/olr"
    PDO_URL: str = "https://psl.noaa.gov/pdo/data/pdo.timeseries.sstens.data"
    IOD_URL: str = "https://psl.noaa.gov/data/timeseries/month/data/dmi.had.long.data"
    SAM_URL: str = "https://psl.noaa.gov/data/20thC_Rean/timeseries/monthly/SAM/sam.20crv3.long.data"
    MJO_URL: str = "https://www.bom.gov.au/climate/mjo/graphics/rmm.74toRealtime.txt"
